...
const SplashScreen = () => {
    return (
        <div class="min-h-screen flex flex-col items-center justify-center animate__animated animate__zoomIn">
            <div class="flex flex-col items-center justify-center">
                ...
                <h2 class="text-center font-bold text-3xl m-[1px]">Diamond ERP</h2>
            </div>
        </div>
    );
};
